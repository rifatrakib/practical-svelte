...
var app = (function () {
    ...
    /* src\Spring.svelte generated by Svelte v3.55.0 */
    ...
    // (60:8) {#each $cards as card, i (card.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 60, 8, 1293);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(60:8) {#each $cards as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 58, 4, 1221);
    			attr_dev(div1, "class", "page svelte-rfm6nt");
    			add_location(div1, file$1, 57, 0, 1198);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*discard, boxes, console*/ 17) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "svelte-klrgt8");
    			add_location(div, file, 57, 8, 1259);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:4) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showParagraph*/ ctx[2] && create_if_block_1(ctx);
    	let if_block1 = /*showParagraph*/ ctx[2] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 45, 0, 956);
    			add_location(hr, file, 50, 0, 1111);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 52, 0, 1119);
    			add_location(button1, file, 53, 0, 1160);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function discard(value) {
    		$$invalidate(0, boxes = boxes.filter(el => el !== value));
    	}
