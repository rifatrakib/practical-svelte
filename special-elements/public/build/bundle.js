...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(13:4) {#if member.isParent}",
    		ctx
    	});
    ...
    // (14:8) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:8) {#each member.children as child}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 11, 4, 125);
    			attr_dev(div, "class", "svelte-1vqz48x");
    			add_location(div, file$1, 10, 0, 114);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
