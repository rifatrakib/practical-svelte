...
var app = (function () {
    ...
    // (41:0) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:0) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	var switch_value = /*renderedItem*/ ctx[0].cmp;

    	function switch_props(ctx) {
    		return {
    			props: {
    				title: /*renderedItem*/ ctx[0].title,
    				id: /*renderedItem*/ ctx[0].id
    			},
    			$$inline: true
    		};
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(button, file, 36, 0, 1025);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*renderedItem*/ 1) switch_instance_changes.title = /*renderedItem*/ ctx[0].title;
    			if (dirty & /*renderedItem*/ 1) switch_instance_changes.id = /*renderedItem*/ ctx[0].id;

    			if (switch_value !== (switch_value = /*renderedItem*/ ctx[0].cmp)) {
    				if (switch_instance) {
    					group_outros();
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('renderedItem' in $$props) $$invalidate(0, renderedItem = $$props.renderedItem);
    	};
    	...
    	return [renderedItem, familyStructure, toggle];
    }
