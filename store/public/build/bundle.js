...
var app = (function () {
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 48, 4, 849);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 41, 2, 591);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$c, 42, 2, 610);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$c, 40, 0, 584);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<CartItem> was created with unknown prop '${key}'`);
    	});
    ...
    class CartItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { title: 0, price: 1, id: 4 });
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$b, 52, 12, 1009);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (50:8) {#each items as item (item.id)}
    function create_each_block$2(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:8) {#each items as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$b, 47, 4, 842);
    			attr_dev(ul, "class", "svelte-1rx6pot");
    			add_location(ul, file$b, 48, 4, 860);
    			attr_dev(section, "class", "svelte-1rx6pot");
    			add_location(section, file$b, 46, 0, 828);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	const unsubscribe = cart.subscribe(its => {
