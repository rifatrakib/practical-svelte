...
var app = (function () {
    ...
    // (56:4) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:4) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (59:4) <Button on:click={removeFromCart}>
    function create_default_slot$6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(59:4) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$d, 60, 8, 1433);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(60:4) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$d, 53, 4, 1157);
    			attr_dev(h2, "class", "svelte-xkc8vd");
    			add_location(h2, file$d, 54, 4, 1178);
    			attr_dev(li, "class", "svelte-xkc8vd");
    			add_location(li, file$d, 52, 0, 1148);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (51:8) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(51:8) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 45, 8, 877);
    			attr_dev(h2, "class", "svelte-1a70imu");
    			add_location(h2, file$2, 46, 8, 902);
    			attr_dev(p, "class", "svelte-1a70imu");
    			add_location(p, file$2, 47, 8, 927);
    			add_location(div0, file$2, 44, 4, 863);
    			add_location(div1, file$2, 49, 4, 963);
    			attr_dev(div2, "class", "product svelte-1a70imu");
    			add_location(div2, file$2, 43, 0, 837);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
