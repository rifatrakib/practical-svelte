...
var app = (function () {
    ...
    // (54:4) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(54:4) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (57:4) <Button on:click={removeFromCart}>
    function create_default_slot$6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(57:4) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 58, 8, 1322);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(58:4) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 51, 4, 1046);
    			attr_dev(h2, "class", "svelte-xkc8vd");
    			add_location(h2, file$c, 52, 4, 1067);
    			attr_dev(li, "class", "svelte-xkc8vd");
    			add_location(li, file$c, 50, 0, 1037);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
